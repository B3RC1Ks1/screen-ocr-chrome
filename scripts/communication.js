      ...
      return new Promise((resolve) => {
        chrome.runtime.sendMessage({ action: "send-ocr-text", text }, (response) => {
          ...
          if (response?.answer) {
            ...
            UI.displayChatGptResponse(response.answer);
      ...
      chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
        switch (message.action) {
          ...
          case "start-ocr-selection":
            ...
            State.setState({ openScreenshot: message.openScreenshot || false, openOcrText: message.openOcrText || false });
            ...
            SelectionOverlay.initSelectionHandlers(overlay);
